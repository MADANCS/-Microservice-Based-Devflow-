...
export const selectTasks    = (s: RootState) => Array.isArray(s?.workspace?.tasks) ? s.workspace.tasks : []
export const selectProjects = (s: RootState) => Array.isArray(s?.workspace?.projects) ? s.workspace.projects : []
